...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7">
				<form name="newAccount" action="./processUpdateAccount.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
					<div class="form-group row">
						<label class="col-sm-2">상품 코드</label>
						<div class="col-sm-3">
							<input type="text" id="accountId" name="AccountId" class="form-control" value='<%=rs.getString("p_id")%>'>
						</div>
					</div>
					<div class="form-group row">
